...
- 🛡️ **القائمة البيضاء للأجهزة المصرح بها (USB Device Whitelist)**: إمكانية تحديد فلاشات وأجهزة USB معتمدة ومصرح بها فقط، وحظر أي جهاز غير مدرج في القائمة مع إرسال إشعار فوري.
